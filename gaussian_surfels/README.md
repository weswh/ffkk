...
To train a scene:
```shell
python train.py -s /home/veily/gaussian_surfels/data/scan24/
```
Trained model will be save in ```output/```.
To render images and reconstruct mesh from a trianed model:
```shell
python render.py -m /home/veily/gaussian_surfels/output/testscan2/colmap_3e5c5980-f/ --img --depth 10
```
