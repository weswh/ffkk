...
DATASETS = {
	'foot_renders': {
		'transforms': transforms_config.Encode128Transforms,
		'train_source_root': dataset_paths['foot_renders'],
		'train_target_root': dataset_paths['foot_renders'],
		'test_source_root': dataset_paths['foot_renders_test'],
		'test_target_root': dataset_paths['foot_renders_test'],
	},
	'ffhq_encode': {
