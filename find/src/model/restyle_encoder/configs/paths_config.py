dataset_paths = {
	'foot_renders': '/data/cornucopia/ob312/neural-feet/rendered_gt_constrained_cam/',
	'foot_renders_test': '/data/cornucopia/jjc75/neural-feet/rendered_gt_constrained_cam_test/',
