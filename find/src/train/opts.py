...
class Opts():
	...
	def __init__(self, validate=False):
		...
		# Dataset args
		p.add_argument('--left_only', default=False, help='Only run on left feet')
		...
		p.add_argument('--low_res_textures',  type=bool, default=False, help="Load low resolution (1K) textures")
		...
		p.add_argument('--no_rendering',  type=bool, default=False ,
		...
		p.add_argument('--texture_loss', type=bool, default=False)
